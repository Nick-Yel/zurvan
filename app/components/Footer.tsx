        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-4 md:gap-4 w-full">
          <div className="flex flex-col gap-4 w-full md:w-[60%] lg:w-[60%]">
            ...
            <div className="flex flex-col sm:flex-row gap-1.5 md:gap-2 w-full max-w-[500px]">
              ...
              <button 
                ...
                className="px-3 md:px-6 py-2 md:py-3 rounded-[10px] bg-[#A50019] font-['Kanit'] font-normal text-xs md:text-base text-white hover:bg-[#8a0015] transition-colors whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? "Subscribing..." : "Subscribe"}
              </button>
            </div>
            {message && (
              <p className={`font-['Kanit'] font-normal text-xs md:text-sm ${message.includes('Success') ? 'text-green-400' : 'text-red-400'}`}>
                {message}
              </p>
            )}
          ...
          <div className="flex flex-col gap-2 md:gap-4 w-full md:w-[196px]">
            ...
            <nav className="flex flex-col items-start gap-1 md:gap-2">
              ...
              <a href="https://www.instagram.com/royisal/" className="flex flex-row items-center py-1 md:py-2 gap-2 md:gap-3 w-full group transition-colors">
                <svg width="16" height="16" viewBox="0 0 24 24" className="md:w-6 md:h-6" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://x.com/RoyiSal" className="flex flex-row items-center py-1 md:py-2 gap-2 md:gap-3 w-full group transition-colors">
                <svg width="16" height="16" viewBox="0 0 24 24" className="md:w-6 md:h-6" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://www.linkedin.com/company/royisal/" className="flex flex-row items-center py-1 md:py-2 gap-2 md:gap-3 w-full group transition-colors">
                <svg width="16" height="16" viewBox="0 0 24 24" className="md:w-6 md:h-6" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://www.youtube.com/@RoyiSalJewelry" className="flex flex-row items-center py-1 md:py-2 gap-2 md:gap-3 w-full group transition-colors">
                <svg width="16" height="16" viewBox="0 0 24 24" className="md:w-6 md:h-6" fill="none" xmlns="http://www.w3.org/2000/svg">

...
export default function RouteThreePage() {
  ...
  return (
    <main className="w-full bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(/assets/page-3.jpg)' }}>
      ...
      <div className="relative overflow-y-auto md:overflow-visible w-full">
        <GallerySection route="3" onAddMemory={handleAddMemoryClick} isUploading={isUploading} />
      </div>
    </div>
    </main>
  );
